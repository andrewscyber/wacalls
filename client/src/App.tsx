      ...
      <AppShell>
        {sessions.length === 0 ? (
          <EmptyState
            ...
            description="Crie sua primeira conta do WhatsApp pela barra lateral para começar a ligar."
          />
        ) : active ? (
          ...
          <EmptyState
            ...
            description="Escolha uma conta na barra lateral para ver as chamadas."
          />
        )}
      </AppShell>
      <IncomingCallModal />
